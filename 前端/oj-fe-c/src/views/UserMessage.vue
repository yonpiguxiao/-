  ...
  <div class="message-list">
    <div class="message-list-block">
      ...
      <div class="mesage-list-content" v-for="(item, index) in messageList" :key="index">
        ...
        <el-button class="mesage-button" type="text" @click="onDelete(item.textId)">删除</el-button>
      </div>
...
<script setup>
import { delMessageService, getMessageListService } from "@/apis/message"
...
async function onDelete(textId) {
    await delMessageService(textId)
    params.pageNum = 1
    getMessageList()  
}
</script>
